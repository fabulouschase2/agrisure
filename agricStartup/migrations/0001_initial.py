# Generated by Django 6.0.1 on 2026-03-24 18:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='agricStartup.crop')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('approved', 'Approved'), ('conditional', 'Conditional'), ('rejected', 'Rejected')], max_length=20)),
